import { Calendar, CalendarDays, CirclePlus, Inbox, Search, Shapes } from "lucide-react";
...
export function SearchIcon(){
  return(
    <div>
      <Search className="w-5 h-5 stroke-gray-600 stroke-1"/>
    </div>
  )
}
export function InboxIcon(){
  return(
    <div>
      <Inbox className="w-5 h-5 stroke-gray-600 stroke-1"/>
    </div>
  )
}
export function TodayIcon(){
  return(
    <div>
      <Calendar className="w-5 h-5 stroke-gray-600 stroke-1"/>
    </div>
  )
}
export function UpcomingIcon(){
  return(
    <div>
      <CalendarDays className="w-5 h-5 stroke-gray-600 stroke-1"/>
    </div>
  )
}
export function FiltersIcon(){
  return(
    <div>
      <Shapes className="w-5 h-5 stroke-gray-600 stroke-1"/>
    </div>
  )
}
